...
MODPLUG_EXPORT unsigned int ModPlug_NumOrders(ModPlugFile* file);
...
MODPLUG_EXPORT unsigned int ModPlug_GetChannelVU(ModPlugFile* file, unsigned channel);
MODPLUG_EXPORT void         ModPlug_GetChannelVUs(ModPlugFile* file, unsigned firstChannel, unsigned lastChannel, unsigned * result);
MODPLUG_EXPORT void         ModPlug_MuteChannel(ModPlugFile* file, unsigned channel, bool mute);
MODPLUG_EXPORT bool         ModPlug_IsChannelMuted(ModPlugFile* file, unsigned channel);
